...
public class day11 {
    public static void main(String[] args) {
        ...
        /*
            ...
            So, let's say that y represents the number of moves required to 
            move all items on a floor up to the next floor and that x 
            represents the number of items that need to be moved.
            ...
            divided by 2 since we are taking 2 per trip. But, we have to also 
            keep in mind that we always have to have at least one item in the 
            elevator as well, so we'll need a constant.
                Symbolically: 
                    y / 2 = x
                    So, y = 2x + C
            ...
            To test our new equation of y = 2x - 3 we can just compare it to 
            ...
            NOTE: This does NOT work with the test or other various inputs 
            because this equation completely ignores the actual items 
            themselves. It doesn't match generators and microchips properly, as 
            required by some instances of the problem. 

            When I tested this against my input it worked. I may come back to 
            solve the problem in a more intentional way eventually, but with 
            how busy I am currently this will suffice.
        */
